...
xl <- c(seq(0.5, 5, 0.1))
tochka =  which( LOO_pramoygolnik == min(LOO_pramoygolnik) )
plot(h_vect,LOO_pramoygolnik, type = "l", xaxt="n", xlab = "h value", ylab = "Error value")
axis(1, at = seq(0.5, 5, by = 0.1), las=1)
#ans = which.min(tochka[,2])

points(h_vect[tochka], LOO_pramoygolnik[tochka], col="red", pch = 19)
